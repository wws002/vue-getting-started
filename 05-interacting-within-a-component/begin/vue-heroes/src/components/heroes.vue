...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 1,
    originDate: format(new Date(1999, 5, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 3,
    originDate: format(new Date(1995, 4, 3), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1998, 7, 8), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 0,
    originDate: format(new Date(2000, 9, 6), inputDateFormat),
...
export default {
  ...
  methods: {
    ...
    async loadHeroes() {
      this.heroes = [];
      this.message = 'getting the heroes. one second please';
